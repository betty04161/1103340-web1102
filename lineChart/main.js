...
function prepareLineChartData(data) {
  ...
  //放進array並排序
  const revenueArray = Array.from(sumOfRevenueByYear).sort(
    (a, b) => a[0] - b[0]
  );
  ...
  const revenueAndBudgetArray = revenueArray
    .map((d) => d[1])
